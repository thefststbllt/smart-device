...
/* harmony import */ var _modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordion/accordion */ "./js/modules/accordion/accordion.js");
/* harmony import */ var _modules_text_more_text_more__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/text-more/text-more */ "./js/modules/text-more/text-more.js");
/* harmony import */ var _modules_form_mask_phone_mask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form-mask/phone-mask */ "./js/modules/form-mask/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll_scroll__WEBPACK_IMPORTED_MODULE_2__["scrollToForm"])();
  Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__["addAccordion"])();
  Object(_modules_text_more_text_more__WEBPACK_IMPORTED_MODULE_4__["toggleText"])();
  Object(_modules_form_mask_phone_mask__WEBPACK_IMPORTED_MODULE_5__["getPhoneMask"])();
...
/* harmony import */ var _utils_platforms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/platforms */ "./js/utils/platforms.js");

var accordionButtons = document.querySelectorAll('.main-footer__title-wrapper');
var footerLists = document.querySelectorAll('.main-footer__list');
var addAccordion = function addAccordion() {
  footerLists.forEach(function (list) {
    return list.classList.add('main-footer__list--hidden');
  });
  ...
  accordionButtons.forEach(function (item) {
    ...
    var toggleAccordion = function toggleAccordion() {
      closeAccordions();
      var elementList = item.nextElementSibling;
      button.classList.remove('main-footer__element-toggle--closed');
      elementList.classList.remove('main-footer__list--hidden');
    };
    if (window.matchMedia("(max-width: ".concat(_utils_platforms__WEBPACK_IMPORTED_MODULE_0__["MAX_DEVICE_WIDTH"].mobile, "px)")).matches) {
...
/***/ "./js/modules/form-mask/phone-mask.js":
/*!********************************************!*\
  !*** ./js/modules/form-mask/phone-mask.js ***!
  \********************************************/
/*! exports provided: getPhoneMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPhoneMask", function() { return getPhoneMask; });
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! imask */ "../node_modules/imask/esm/index.js");

var iMask = imask__WEBPACK_IMPORTED_MODULE_0__["default"];
var phoneInputs = document.getElementsByName('user-phone');
var getPhoneMask = function getPhoneMask() {
...
var infoButton = document.querySelector('.main-info__button');
var feedbackForm = document.querySelector('.main-content__feedback');
...
var aboutContainer = document.querySelector('.about__container');
var buttonAbout = aboutContainer.querySelector('.button--about');
var textParagraphs = aboutContainer.querySelectorAll('p');
var toggleText = function toggleText() {
  var mobileWidth = window.matchMedia("(max-width: ".concat(_utils_platforms__WEBPACK_IMPORTED_MODULE_0__["MAX_DEVICE_WIDTH"].mobile, "px)"));
  ...
  buttonAbout.addEventListener('click', function () {
    var checkHiddenParagraphs = function checkHiddenParagraphs() {
      return Array.from(textParagraphs).some(function (p) {
...
/* harmony import */ var _platforms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./platforms */ "./js/utils/platforms.js");

var iosChecker = function iosChecker() {
  return _platforms__WEBPACK_IMPORTED_MODULE_0__["PLATFORMS"].includes(navigator.platform) || navigator.userAgent.includes('Mac') && 'ontouchend' in document;
};
...
var iosVhFix = function iosVhFix() {
  ...
  if (!(window.MSInputMethodContext && document.documentMode)) {
    if (Object(_ios_checker__WEBPACK_IMPORTED_MODULE_0__["iosChecker"])()) {
      document.documentElement.style.setProperty('--vh', "".concat(viewHeight, "px"));
...
/*!*******************************!*\
  !*** ./js/utils/platforms.js ***!
  \*******************************/
/*! exports provided: PLATFORMS, MAX_DEVICE_WIDTH */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PLATFORMS", function() { return PLATFORMS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAX_DEVICE_WIDTH", function() { return MAX_DEVICE_WIDTH; });
var MAX_DEVICE_WIDTH = {
  mobile: 767
};
...
var ScrollLock = /*#__PURE__*/function () {
  function ScrollLock() {
    ...
    this._lockClass = Object(_ios_checker__WEBPACK_IMPORTED_MODULE_0__["iosChecker"])() ? 'scroll-lock-ios' : 'scroll-lock';
